#!/usr/bin/python3
"""Module to test classes"""
import inspect
import pep8


class TestClassDocumentation():
    """Class that enables testing of multiple classess"""
    ...
    def documentation(self):
        """Documentation for testing the module, class, and methods."""
    ...
    def pep8(self, files):
        """Conducts PEP8 linter test across the files."""
